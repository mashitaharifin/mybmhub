...
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-5 transition-colors hover:bg-red-50 dark:hover:bg-red-800/20 h-full flex flex-col">
  ...
  {:else}
    <div class="flex-1 space-y-3 max-h-[350px] overflow-y-auto pr-2">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="mt-1">
              <span class="inline-block px-2 py-0.5 text-[10px] font-medium rounded-full
                {activity.type === 'attendance' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 
                 activity.type === 'leave' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300' :
                 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300'}">
                {activity.type === 'attendance' ? 'Attendance' : 
                 activity.type === 'leave' ? 'Leave' : 'Notification'}
              </span>
            </div>
          </div>
        </div>
