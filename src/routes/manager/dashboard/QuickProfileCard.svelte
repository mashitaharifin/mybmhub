...
<GlassCard className="w-full">
	<!-- Title -->
	<h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3 lg:mb-2">
		Profile Card
	</h2>
	...
	<div class="flex items-center gap-6">
		<!-- Avatar -->
		<div
			class="w-18 h-18 p-1 rounded-full bg-gradient-to-br
			from-pink-300 via-red-300 to-red-300
			dark:from-[#2a0f1f] dark:via-[#3b164a] dark:to-[#7a1f3d]
		...
		<div class="flex-1 text-gray-800 dark:text-gray-200">
			...
			{:else}
				...
				<div class="text-sm text-gray-500 dark:text-gray-200 mt-0.5">
					{employee.role}
				</div>
				<div class="text-xs text-gray-400 dark:text-gray-300 mt-0.5">
					{employee.jobTitle}
				</div>
			{/if}
		</div>
		...
		<div class="flex flex-col gap-2">
			<a
				...
				class="text-red-600 dark:text-gray-400
				hover:text-red-500 hover:dark:text-purple-600 transition-colors"
			>
